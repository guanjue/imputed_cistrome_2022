...
class LightGBMModel(object):
    def __init__(self, config_file, training_tf_name=None,
        ...
        if training_tf_name is not None:
            print('ok')
            self.df_all_regions_label = pd.read_csv('/liulab/gjxiang/projects/impute_cistrome/cistrome_impute_results_mouse/label/train/NR4A1.train.labels.tsv', sep="\t", header=0)
    ...
    def prepare_motif_h5_data(self, chrom):
        ...
        print('check1')
        with h5py.File("%s/%s_motifs_top4_scores.h5" % ('/liulab/gjxiang/projects/impute_cistrome/cistrome_impute_results_mouse/hdf5s/motif', chrom), "r") as infile:
