...
# LICENSE: BSD
#
# Modified by K.S. Brown 2015 for standalone assingnment problems; could not get
# most recent version of scikits-learn to build on 64-bit Mac OS X.  In addition,
# very little of scikits-learn is needed to perform the calculation.
#
