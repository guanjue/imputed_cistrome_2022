...
def train_lgb_model(self, DNase_h5, DNase_h5_test, motif_h5, motif_h5_test, sigtype, cell_line, chrom, chrom_test, TFname, label_file_train_topN, label_file_train, label_file_test, dir_out):
	print(DNase_h5)
	print(motif_h5)
	print(cell_line)
	print(chrom)
	...
	train_chr = ['chr5', 'chr9', 'chr10', 'chr11', 'chr14', 'chr18', 'chr19']
	...
	print('test motif')
	for chrom_test in ['chr1', 'chr21', 'chr8']:
		...
		print('write output')
		outputname = dir_out+TFname+'.'+str(cell_line)+'.'+chrom+'.'+chrom_test+'.lgb.pred.txt'
