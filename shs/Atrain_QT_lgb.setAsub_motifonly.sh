...
label_file_test='peaks/5fc/'$TF'.test.qthresh.label.tsv'
...
/usr/bin/time --verbose python $scripts_dir/train.crosschr.setAsub.motifonly.py train_lgb_model --chrom=$chrom_j --chrom_test=$chrom_j_test --TFname=$TF \
