...
head -5000 $pksumit_folder$tf_id1'_sort_summits.bed' | cut -f1,2,3 > peaks/top5k/$TF/$tf_id1'_sort_peaks.narrowPeak.top.bed'
...
do
	echo $tf_id
	head -5000 $pksumit_folder$tf_id'_sort_summits.bed' | cut -f1,2,3 > peaks/top5k/$TF/$tf_id'_sort_peaks.narrowPeak.top.bed'
